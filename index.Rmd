...
depenses <- reactive({
  ...
  if (input$masquer_dep_nulles == "TRUE") {
    dep <- dep |> 
      filter(montant != 0)
  }
...
<p style="font-size:.9em;">Voir l'Aide. N'impacte pas le total consommé.</p>
...
# Synthèse par déplacement / commande {data-navmenu="Détails MAP"}
...
Pour simplifier l'affichage, cette option permet d'exclure du tableau de bord les dépenses dont le montant total est nul et donc sans impact sur la consommation du budget.
